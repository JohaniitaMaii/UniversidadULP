 ...
 * @author Usuario
 */
public class MateriaAlumno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Inscripciones");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MateriaAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MateriaAlumno().setVisible(true);
            }
        });
    }
